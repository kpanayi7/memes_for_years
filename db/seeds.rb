...
user_1 = User.create!(name:"Dave", email:"dave@pushflo.com", password:"1234567")
puts "created user"
user_2 = User.create!(name:"Kyri", email:"kyri@pufhflo.com", password:"7654321")
puts "created user"
user_3 = User.create!(name:"Nelson", email:"nelson@pushflo.com", password:"1234567")
puts "created user"
user_4 = User.create!(name:"Rahul", email:"rahul@pushflo.com", password:"1234567")
puts "created user"
user_5 = User.create!(name:"Meehir", email:"meehir@pufhflo.com", password:"1234567")
puts "created user"
user_6 = User.create!(name:"Zak", email:"zak@pushflo.com", password:"1234567")
puts "created user"

eggmeme=MemeCreatorListing.new(creator_name:"Eggmeister", speciality:"Egg Meme Specialist", user_id:user_1.id)
eggmeme.photo.attach(io: file1, filename: "egg.png", content_type: 'image/jpg')
eggmeme.save!

catmeme=MemeCreatorListing.new(creator_name:"Meeyaaaw", speciality:"Cat Meme Specialist", user_id:user_2.id)
catmeme.photo.attach(io: file2, filename: "cat.png", content_type: 'image/jpg')
catmeme.save!

borismeme=MemeCreatorListing.new(creator_name:"Bozza", speciality:"Boris Johnson Meme Specialist", user_id:user_3.id)
borismeme.photo.attach(io: file3, filename: "boris.png", content_type: 'image/jpg')
borismeme.save!

djmeme=MemeCreatorListing.new(creator_name:"Deejay", speciality:"DJ Meme Specialist", user_id:user_4.id)
djmeme.photo.attach(io: file4, filename: "dj.png", content_type: 'image/jpg')
djmeme.save!

dogmeme=MemeCreatorListing.new(creator_name:"Hugh Let the Dogs Out", speciality:"Dog Meme Specialist", user_id:user_5.id)
dogmeme.photo.attach(io: file5, filename: "dog.png", content_type: 'image/jpg')
dogmeme.save!

codingmeme=MemeCreatorListing.new(creator_name:"Query Selecta Ta Ta", speciality:"Coding Meme Specialist", user_id:user_6.id)
